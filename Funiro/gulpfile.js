...
const mainTasks = gulp.series(fonts, gulp.parallel(copy, html, scss, js, resources, images));
...
const build = gulp.series(resetBuild, fontsBuild, htmlBuild, cssBuild, jsBuild, resourcesBuild, imagesBuild, svgSprites);
