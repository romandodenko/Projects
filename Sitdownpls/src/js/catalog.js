  ...
  document.querySelectorAll(".btn-furniture").forEach(function(btnFurniture) {
    btnFurniture.addEventListener("click", function() {
      document.querySelectorAll(".btn-close-furniture").forEach(function(btnCloseFurniture) {
        btnCloseFurniture.classList.add("vis")
      })
        btnFurniture.classList.add("hid")
...
document.querySelectorAll(".btn-close-furniture").forEach(function(butCloseFurniture) {
  butCloseFurniture.addEventListener("click", function() {
    document.querySelectorAll(".btn-furniture").forEach(function(butFurniture) {
      butFurniture.classList.remove("hid")
    })
    butCloseFurniture.classList.remove("vis")
  ...
  document.querySelectorAll(".color-btn").forEach(function(btnColor) {
    btnColor.addEventListener("click", function() {
      document.querySelectorAll(".color-close-btn").forEach(function(btnCloseColor) {
        btnCloseColor.classList.add("vis")
      })
      btnColor.classList.add("hid")
      colorItems.timeScale(1).play()
    })
  })

document.querySelectorAll(".color-close-btn").forEach(function(butCloseColor) {
  butCloseColor.addEventListener("click", function() {
    document.querySelectorAll(".color-btn").forEach(function(butColor) {
      butColor.classList.remove("hid")
    })
    butCloseColor.classList.remove("vis")
...
document.querySelectorAll(".catalog__closecolor").forEach(function(butCloseColor) {
butCloseColor.addEventListener("click", function() {
  document.querySelectorAll(".catalog__btncolor").forEach(function(butColor) {
    butColor.classList.remove("hid")
  })
  butCloseColor.classList.remove("vis")
  colorItems.timeScale(2).reverse()
...
// Catalog 
// Tabs 
  document.querySelectorAll(".catalog-but").forEach(function (tabsBtn) {
    tabsBtn.addEventListener("click", function (event) {
      const path = event.currentTarget.dataset.path

      document.querySelectorAll(".catalog__wrapper").forEach(function (tabContent) {
        tabContent.classList.remove("catalog-list-active")
      })
      document.querySelector(`[data-target="${path}"]`).classList.add("catalog-list-active")
    })
  })
  // Tabs
  // Tabs btn
  ...
  document.querySelectorAll(".catalog-but").forEach(function (but) {
    but.addEventListener("click", function (event) {
      const pathbut = event.currentTarget.dataset.pathbut

      document.querySelectorAll(".catalog-but").forEach(function (butA) {
        butA.classList.remove("but-active")
      })
      document.querySelector(`[data-targetbut="${pathbut}"]`).classList.add("but-active")
      top()
    })
  })
  // Tabs btn
